...
<template>
  ...
  >
    <div class="flex items-center justify-center px-2 mb-3 mx-auto">
      ...
      <blur-reveal :delay="0.2" :duration="0.75">
        ...
        <span class="font-light text-gray-600">
          GitHubのコードデータを使って、あなたの「コーディングDNA」を解析します。
        </span>
      </blur-reveal>
    </div>
    ...
    >
      ...
      <div>
        <span class="font-medium">コードやコミット履歴を取得します</span>
        <ul class="mt-1.5 list-disc list-inside">
          <li>取得するのは公開リポジトリのみです</li>
          <li>解析に必要な情報だけを使用し、他の目的には使いません</li>
        </ul>
      </div>
    </div>
